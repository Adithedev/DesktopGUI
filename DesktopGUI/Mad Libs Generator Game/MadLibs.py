...
Button(root, text= "apple and apple", font = "arial 15", command= madlib2, bg= "ghost White").place (x=60, y=180)

Button(root, text= "The Butterfly", font = "arial 15", command= madlib3, bg= "ghost White").place (x=60, y=240)
